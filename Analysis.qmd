...
There is a statistically significant difference between the off-site and on-site groups in terms of the number of years they have had bronchitis or chronic coughing. The off-site group has a longer history (median 13 years) compared to the on-site group (median 10 years), and the p-value (0.024) indicates that this difference is statistically significant at the 5% level.

There is a marginally statistically significant difference (p = 0.050) between the groups in terms of the number of months with bronchitis or coughing in the last year. The off-site group again reports a slightly higher duration (median 6 months) compared to the on-site group (median 5 months). This result is right on the threshold of significance.


### D) Do you kNow about COPD and its affect in your quality of life?+ education level 
